                ...
                Object.keys(getCurrentDrink).length > 0 ?
                    <SC.CurrentDrinkBanner key={getCurrentDrink.idDrink}>
                        ...
                        <SC.CurrentDrinkItem style={{width:"100%"}}>
                            <SC.Paragraph><SC.Span> instructions: </SC.Span>  {getCurrentDrink.strInstructions}</SC.Paragraph>

                            <SC.Paragraph><SC.Span> modified: </SC.Span>  {getCurrentDrink.dateModified && getCurrentDrink.dateModified.split(" ", 1)}</SC.Paragraph>
                        </SC.CurrentDrinkItem>
